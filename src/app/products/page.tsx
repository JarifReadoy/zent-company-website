...
interface Product {
  ...
  fullDescription: string; icon: string; features: string[];
  benefits: string[]; useCases: string[]; featured: boolean;
}
      ...
      <main className="flex-1">
        <section className="relative bg-muted/20 pt-24 pb-12 sm:pt-32 sm:pb-16 text-center">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <h1 className="text-4xl font-display font-bold tracking-tight text-foreground sm:text-6xl">Enterprise-Grade Products</h1>
        ...
        <Section className="bg-muted/10">
          <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
            ...
            <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">Our products are designed to work together and integrate with your existing technology stack.</p>
        ...
        <section className="relative isolate overflow-hidden bg-primary py-16 sm:py-24">
          <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
            <h2 className="text-3xl font-bold tracking-tight text-primary-foreground sm:text-4xl">Ready to Transform Your Business?</h2>
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-primary-foreground/90">Schedule a personalized demo with our solution architects today.</p>
