...
export default function PortfolioPage() {
  const portfolio = readData<Project[]>('portfolio.json').filter(p => p.published)
      ...
      <main className="flex-1">
        <section className="relative bg-background py-24 sm:py-32 text-center border-b">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="inline-block rounded-full bg-primary/10 px-3 py-1 text-sm font-semibold text-primary mb-4">Proven Results</div>
            <h1 className="text-4xl font-display font-bold tracking-tight text-foreground sm:text-6xl">Success Stories</h1>
